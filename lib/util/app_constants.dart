...
class AppConstants {
  static const String APP_NAME = 'MogoMunch';
  static const double APP_VERSION = 5.8;

  static const String BASE_URL = 'https://admin.mogomunch.com';
  ...
  static const String LOGIN_OTP_URI = '/api/v1/auth/otp-login';
  static const String TOKEN_URI = '/api/v1/customer/cm-firebase-token';
  static const String PLACE_ORDER_URI = '/api/v1/customer/order/place';
  static const String ADDRESS_LIST_URI = '/api/v1/customer/address/list';
  static const String ADDRESS_URI = '/api/v1/customer/address/get-mogo-code';
