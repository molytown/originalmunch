...
import 'package:efood_multivendor/view/base/text_hover.dart';
      ...
      child: TextHover(builder: (hovered) {
        return Row(children: [
          Stack(clipBehavior: Clip.none, children: [
            ...
            Icon(icon, size: 20, color: hovered ? Colors.blue : null),
          ...
          Text(title, style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: hovered ? Colors.blue : null)),
        ]);
      }),
    );
  }
