...
import 'package:efood_multivendor/view/screens/menu/widget/html_button_dialog.dart';
      ...
      child: Column(children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            color: isLogout ? Get.find<AuthController>().isLoggedIn() ? Colors.red : Colors.green : menu.color,
