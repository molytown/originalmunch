...
class _UpdateProfileScreenState extends State<UpdateProfileScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BgWidget(child: GetBuilder<UserController>(builder: (userController) {
        if(userController.userInfoModel != null && _phoneController.text.isEmpty) {
          _nameController.text = userController.userInfoModel.fName ?? '';
  ...
  void _updateProfile(UserController userController) async {
    ...
    if (userController.userInfoModel.fName == _name && userController.userInfoModel.phone == _phoneNumber &&
      ...
      UserInfoModel _updatedUser = UserInfoModel(fName: _name, lName: '', email: _email, phone: _phoneNumber);
