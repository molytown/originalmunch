            ...
            Expanded(
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Row(children: [
                  ...
                  (address.contactPersonName != null && address.contactPersonName.isNotEmpty) ? Text(
                    '(${address.contactPersonName})',
                    style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Colors.blueAccent),
