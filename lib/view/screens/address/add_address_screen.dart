...
class _AddAddressScreenState extends State<AddAddressScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BgWidget(child: _isLoggedIn ? GetBuilder<UserController>(builder: (userController) {
        if(widget.address != null) {
          ...
          return Column(children: [
            ...
            Expanded(child: Scrollbar(child: SingleChildScrollView(
              ...
              child: Center(child: SizedBox(width: Dimensions.WEB_MAX_WIDTH, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Text(
                  'give_address_a_label'.tr,
                  style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).disabledColor),
                ),
                SizedBox(height: Dimensions.PADDING_SIZE_SMALL),
                MyTextField(
                  hintText: 'give_address_a_label'.tr,
                ...
                Text(
                  'house'.tr + ' / ' + 'floor'.tr + ' ' + 'number'.tr + ' (${'optional'.tr})',
                  style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).disabledColor),
                ),
                SizedBox(height: Dimensions.PADDING_SIZE_SMALL),
                Row(
            ...
            Container(
              ...
              child: !locationController.isLoading ? CustomButton(
                ...
                onPressed: locationController.loading ? null : () {
                  ...
                  //   showCustomSnackBar('remove_space_from_mogo_code');
                  // }else {
                  //
                  // }
