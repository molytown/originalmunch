...
class _CheckoutScreenState extends State<CheckoutScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BgWidget(child: _isLoggedIn ? GetBuilder<LocationController>(builder: (locationController) {
          ...
          return GetBuilder<CouponController>(builder: (couponController) {
            return GetBuilder<OrderController>(builder: (orderController) {
              ...
              if(restController.restaurant != null && orderController.distance != null && orderController.distance != -1 ) {
                ...
                double _zoneCharge = zoneData.perKmShippingCharge;
                ...
                double _minimumCharge = restController.restaurant.selfDeliverySystem == 1 ? restController.restaurant.minimumShippingCharge
                    :  (_zoneCharge != null ? zoneData.minimumShippingCharge
                ...
                _isCashOnDeliveryActive = zoneData.cod;
                _isDigitalPaymentActive = zoneData.digitalPayment;
