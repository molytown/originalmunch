  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        body: SafeArea(child: BgWidget(child: Center(
          child: Scrollbar(
                  ...
                  child: GetBuilder<AuthController>(builder: (authController) {
                    ...
                    return Column(children: [
                          ...
                          Row(children: [
                            CodePickerWidget(
                              ...
                              initialSelection: _countryDialCode != null ? Get.find<AuthController>().getUserCountryCode().isNotEmpty ? Get.find<AuthController>().getUserCountryCode()
                                  : CountryCode.fromDialCode(_countryDialCode).code : Get.find<LocalizationController>().locale.countryCode,
                      ...
                      Row(children: [
                        ...
                        TextButton(
                          onPressed: () => Get.toNamed(RouteHelper.getForgotPassRoute(false, null, false)),
                      ...
                      !authController.isLoading ? CustomButton(
                        buttonText: 'sign_in_with_otp'.tr, transparent: true,
                        onPressed: authController.acceptTerms ? () => Get.toNamed(RouteHelper.getForgotPassRoute(false, null, true)) : null,
                      ) : SizedBox(),
