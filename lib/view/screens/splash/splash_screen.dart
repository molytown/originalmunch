    ...
    return Scaffold(
      ...
      body: GetBuilder<SplashController>(builder: (splashController) {
        return splashController.hasConnection ? Container(
          ...
          decoration: BoxDecoration(image: DecorationImage(image: AssetImage(Images.splash_bg), fit: BoxFit.fill)),
          alignment: Alignment.center,
          child: Image.asset(Images.logo, width: 200),
        ) : Center(child: NoInternetScreen(child: SplashScreen(body: widget.body)));
      }),
    );
  }
}
