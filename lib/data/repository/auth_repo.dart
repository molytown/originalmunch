...
class AuthRepo {
  ...
  Future<Response> loginWithOtp({@required String phone}) async {
    return await apiClient.postData(AppConstants.LOGIN_OTP_URI, {"phone": phone});
  }
  ...
  Future<Response> verifyToken(String phone, String token) async {
    return await apiClient.postData(AppConstants.VERIFY_TOKEN_URI, {"email": phone, "reset_token": token});
  }
  ...
  Future<Response> resetPassword(String resetToken, String number, String password, String confirmPassword) async {
    return await apiClient.postData(
      ...
      {"_method": "put", "reset_token": resetToken, "email": number, "password": password, "confirm_password": confirmPassword},
    );
  }
