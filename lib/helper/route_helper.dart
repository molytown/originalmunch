...
class RouteHelper {
  ...
  static String getForgotPassRoute(bool fromSocialLogin, SocialLogInBody socialLogInBody, bool otpLogin) {
    String _data;
    if(fromSocialLogin) {
      _data = base64Encode(utf8.encode(jsonEncode(socialLogInBody.toJson())));
    }
    return '$forgotPassword?page=${fromSocialLogin ? 'social-login' : otpLogin ? 'otp-login' : 'forgot-password'}&data=${fromSocialLogin ? _data : 'null'}';
  }
  ...
  static List<GetPage> routes = [
    ...
    GetPage(name: forgotPassword, page: () {
      ...
      return ForgetPassScreen(
        fromSocialLogin: Get.parameters['page'] == 'social-login', socialLogInBody: _data,
        fromOtpLogin: Get.parameters['page'] == 'otp-login',
      );
    }),
    ...
    GetPage(name: addAddress, page: () => AddAddressScreen(fromCheckout: Get.parameters['page'] == 'checkout', zoneId: int.parse(Get.parameters['zone_id']))),
